...
async function* __asyncSliceFromStart(source, start = 0, end = Infinity, step = 1) {
  let currentPos = 0;
...
async function* __asyncSlice(source, start = 0, end = Infinity, step = 1) {
  if (start >= 0) {
...
const asyncSlice = /*#__PURE__*/asyncIterableCurry(__asyncSlice, {
