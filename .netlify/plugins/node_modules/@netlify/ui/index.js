...
import "@netlify/netlify-design-tokens";
import Downshift from "downshift";
import { getAccountNormalizedPlanName, getAccountPlanTitle } from "./helpers/account.js";
...
import { getStandardPlanNames } from "./helpers/plans.js";
import { getAccountCreatePlan, getCreatePlanCapabilities, getPlanCapabilities, getPlanCapabilitiesForUI, getPlanChangeInfo, humanizePlanName, isPlanAgencyBenefit, isPlanBusiness, isPlanBusinessOrHigher, isPlanEnterprise, isPlanEnterpriseLevel, isPlanEnterpriseOrHigher, isPlanEnterpriseTrial, isPlanFree, isPlanFreeOrStarter, isPlanIndia, isPlanLegacyCreate, isPlanLegacyMultiplayerStarter, isPlanNetlifriend, isPlanOpenSource, isPlanOpenSourceUnlimited, isPlanOrb, isPlanPro, isPlanProOrHigher, isPlanScheduledDowngrade, isPlanSelfServe, isPlanStandard, isPlanStarter, isPlanTypeOpenSource, isPlanValidForLockedAccounts, normalizeTeamPlanName } from "./helpers/plans.js";
import { getSiteAddonsInfo, humanizeSubscriptionName } from "./helpers/subscriptions.js";
  ...
  return /* @__PURE__ */ jsxs("picture", { onError, className, children: [
    ...
    /* @__PURE__ */ jsx(
      "img",
      {
        ...
        height,
        loading: "lazy",
        className: cn("tw-align-top", cover && "tw-size-full"),
        title
      }
    )
  ] });
...
const ButtonIcon = React__default.forwardRef(
  ({
    ...
    const commonProps = {
      "aria-label": label,
      className: cn(CN, `btn-icon--size-${size}`),
      onClick: handleClick,
      disabled,
      ...saving && { "aria-disabled": true },
...
const KeyboardShortcut = () => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx("kbd", { className: "tw-font-sans tw-text-xs tw-leading-none tw-text-gray-darker dark:tw-text-gray-light", children: osControlKey() }),
  /* @__PURE__ */ jsx("kbd", { className: "tw-text-xs tw-leading-none tw-text-gray-darker dark:tw-text-gray-light", children: "K" })
] });
    ...
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "span",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("span", { className: "tw-flex tw-min-w-0 tw-flex-1 tw-items-center", children: [
              /* @__PURE__ */ jsx(
                DecorativeIcon,
                {
                  className: cn(
              ...
              /* @__PURE__ */ jsxs(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "tw-hidden @[55px]/SearchButtonLabel:tw-inline", children: "Search" }),
                    /* @__PURE__ */ jsx("span", { className: "tw-hidden @[55px]/SearchButtonLabel:tw-inline @[132px]/SearchButtonLabel:tw-hidden", children: "…" }),
                    " ",
                    /* @__PURE__ */ jsx("span", { className: "tw-hidden @[132px]/SearchButtonLabel:tw-inline", children: "Netlify…" })
                  ]
                }
              )
            ] }),
            !isProbablyMobileDevice() && /* @__PURE__ */ jsx(
              "span",
              {
                className: cn(
                ...
                children: /* @__PURE__ */ jsx(KeyboardShortcut, {})
              }
            )
          ]
        }
...
function Placeholder({
  ...
  return /* @__PURE__ */ jsx(
    "span",
    {
      className: cn(iconCN$1, className),
      ...accessibilityProps,
      style: {
    ...
    "span",
    {
      ...
      children: src ? /* @__PURE__ */ jsx(
        Picture,
        {
          ...
          className: cn(imageCN, elementClassName),
          url: src,
          height: 208,
          width: 208,
          cover: true
...
const PlanBadge = ({
  ...
  const standardPlans = getStandardPlanNames().map((p) => p.toLowerCase());
  ...
  return /* @__PURE__ */ jsx(
    Dropdown,
    {
      ...
      toggle: {
        ...
        label: /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("span", { className: "tw-relative tw-flex tw-size-[34px] tw-max-w-full tw-shrink-0 tw-items-center tw-rounded-full tw-text-transparent tw-ring-[1.5px] tw-ring-[currentColor] tw-transition-colors tw-duration-150 group-hover:tw-text-teal-action group-[.is-active]:tw-text-teal-action dark:group-hover:tw-text-teal-action dark:group-[.is-active]:tw-text-teal-action", children: /* @__PURE__ */ jsx(Avatar, { user, dropdown: true }) }),
          /* @__PURE__ */ jsxs(
            "span",
            {
              className: cn(
      ...
      menu: {
        className: cn(menuPosition === "below" && "tw-top-10 tw-mt-1")
      },
      menuPosition,
...
export {
  ...
  generateImageUrl,
  getAccountCreatePlan,
  getAccountNormalizedPlanName,
  getAccountPlanTitle,
  getActualSizeForNumberValue,
  getCreatePlanCapabilities,
  getPlaceholderGradientColorsFromId,
  getPlanCapabilities,
  getPlanCapabilitiesForUI,
  getPlanChangeInfo,
  getSiteAddonsInfo,
  getStandardPlanNames,
  hideOnEsc,
  hideOnPopperBlur,
  humanizePlanName,
  humanizeSubscriptionName,
  isAvatarUrlCustomUpload,
  isExternalTeamsOrganization,
  isNetlifyUrl,
  isPlanAgencyBenefit,
  isPlanBusiness,
  isPlanBusinessOrHigher,
  isPlanEnterprise,
  isPlanEnterpriseLevel,
  isPlanEnterpriseOrHigher,
  isPlanEnterpriseTrial,
  isPlanFree,
  isPlanFreeOrStarter,
  isPlanIndia,
  isPlanLegacyCreate,
  isPlanLegacyMultiplayerStarter,
  isPlanNetlifriend,
  isPlanOpenSource,
  isPlanOpenSourceUnlimited,
  isPlanOrb,
  isPlanPro,
  isPlanProOrHigher,
  isPlanScheduledDowngrade,
  isPlanSelfServe,
  isPlanStandard,
  isPlanStarter,
  isPlanTypeOpenSource,
  isPlanValidForLockedAccounts,
  linkCN,
  logoSizeCN,
