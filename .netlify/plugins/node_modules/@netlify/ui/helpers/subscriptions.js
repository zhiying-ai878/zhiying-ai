...
const humanizeSubscriptionName = (subscriptionName) => subscriptionName.split("_").map(capitalize).join(" ");
...
export {
  getSiteAddonsInfo,
  getSubscriptionSiteUsage,
  humanizeSubscriptionName,
  isSubscriptionUsageBased,
  transformOrbSubscriptions,
  transformZuoraSubscriptions
};
