...
exports.setErrorType = exports.setPolyfills = exports.setOptions = void 0;
...
function setOptions(options, replace = false) {
    config.options = replace ? options : (0, utils_js_1.mix)(config.options, options);
}
...
function setPolyfills(polyfills, replace = false) {
    config.polyfills = replace ? polyfills : (0, utils_js_1.mix)(config.polyfills, polyfills);
}
