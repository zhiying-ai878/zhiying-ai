...
exports.throttlingCache = void 0;
/* Defaults */
const defaultSkip = (_url, opts) => (opts.skipCache || opts.method !== "GET");
...
const throttlingCache = ({ throttle = 1000, skip = defaultSkip, key = defaultKey, clear = defaultClear, invalidate = defaultInvalidate, condition = defaultCondition, flagResponseOnCacheHit = "__cached" } = {}) => {
    const cache = new Map();
...
exports.throttlingCache = throttlingCache;
