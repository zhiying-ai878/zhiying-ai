...
const Layout: React.FC<LayoutProps> = React.memo(({ children, onLogout, language, onLanguageChange, currentUser, onUserSwitch, onManageAuthorization }) => {
  ...
  const menuItems = useMemo(() => [
    ...
    { key: '/ai-assistant', icon: <MessageOutlined />, label: t('navigation.aiAssistant') },
  ], [t]);
      ...
      <AntLayout style={{ marginLeft: headerLeft, transition: 'margin-left 0.3s', minHeight: '100vh', position: 'relative' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            {currentUser.username === '15983768460' && onManageAuthorization && (
              <Button 
                type="text" 
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginRight: '4px', cursor: 'pointer' }} onClick={onUserSwitch}>
              <Avatar src={currentUser.avatar} style={{ marginRight: '6px', backgroundColor: currentUser.isAuthorized ? '#52c41a' : '#d9d9d9' }} size="small" />
