...
const NotificationList: React.FC = () => {
  ...
  const handleTestNotification = () => {
    const testNotifications = [
      { title: '测试通知', message: '这是一条测试通知消息', type: 'info' as const },
      { title: '交易信号', message: '贵州茅台(600519)出现买入信号', type: 'success' as const },
      { title: '风险提醒', message: '市场波动较大，请注意风险控制', type: 'warning' as const },
    ];
