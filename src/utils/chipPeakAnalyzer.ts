import type { KLineData } from './stockData';
...
export class ChipPeakAnalyzer {
  private readonly priceStep = 0.01;
  private readonly peakThreshold = 0.05;
  ...
  generateChipDistribution(
    ...
    let totalVolume = 0;
    const tempPeaks: { price: number; volume: number }[] = [];
  ...
  analyzeChipDistribution(distribution: ChipDistribution): {
...
let chipPeakAnalyzerInstance: ChipPeakAnalyzer | null = null;
