...
const App = () => {
    ...
    return (_jsx(ConfigProvider, { locale: getAntdLocale(), children: _jsx(Router, { children: isLoggedIn && currentUser ? (_jsxs(_Fragment, { children: [_jsx(Layout, { onLogout: handleLogout, language: language, onLanguageChange: handleLanguageChange, currentUser: currentUser, onUserSwitch: () => setShowUserSwitcher(true), onManageAuthorization: handleManageAuthorization, children: _jsx(Suspense, { fallback: _jsx("div", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh' }, children: _jsx(Spin, { size: "large" }) }), children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "/signal", element: _jsx(Signal, {}) }), _jsx(Route, { path: "/trade", element: _jsx(Trade, {}) }), _jsx(Route, { path: "/ai-assistant", element: _jsx(AIAssistant, {}) }), _jsx(Route, { path: "/prediction-test", element: _jsx(PredictionTestPage, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }) }), _jsxs(Modal, { title: "\u5207\u6362\u7528\u6237", open: showUserSwitcher, onCancel: () => setShowUserSwitcher(false), footer: [
                            ...
                            _jsx(Button, { onClick: handleCancelAuthorizationManagement, children: "\u5173\u95ED" }, "cancel")
                                        ...
                                        _jsx(Button, { type: user.isAuthorized ? 'default' : 'primary', onClick: () => handleToggleAuthorization(user), disabled: user.username === '15983768460', children: user.isAuthorized ? '取消授权' : '授权' })
                                    ], children: _jsx(List.Item.Meta, { avatar: _jsx(Avatar, { src: user.avatar, style: { backgroundColor: user.isAuthorized ? '#52c41a' : '#d9d9d9' } }), title: _jsx(Text, { strong: true, children: user.username }), description: user.username === '15983768460'
                                            ? '系统管理员 (默认授权)'
                                            : user.isAuthorized
