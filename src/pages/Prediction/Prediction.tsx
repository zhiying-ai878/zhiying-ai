...
import { createModel, generateAdvancedTradeSignal, ModelType, TrainingParams, calculateMA, calculateRSI, calculateMACD, calculateBollingerBands } from '../../utils/machineLearningModel';
...
const Prediction = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const prediction = generateAdvancedTradeSignal(prices, model, currentPrice);
