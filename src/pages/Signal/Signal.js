...
const Signal = () => {
    ...
    const generateMockSignals = () => {
        ...
        if (Math.random() > 0.6) {
            signalManager.processPredictionData(randomStock.code, randomStock.name, randomStock.price);
        }
        loadSignals();
    };
