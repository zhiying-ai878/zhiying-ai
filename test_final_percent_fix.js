...
async function testFinalPercentFix() {
    console.log('最终测试涨跌百分比修复效果...');
    ...
    try {
        ...
        const shChangePercentValue = shData.f4 / 100;
        ...
        // 涨跌百分比：无论是指数还是股票，都需要除以100
        const kcChangePercentValue = kcData.f4 / 100;
        ...
        console.log('  涨跌百分比:', kcChangePercentValue.toFixed(2) + '%');
        ...
        // 涨跌百分比：无论是指数还是股票，都需要除以100
        const stockChangePercentValue = stockData.f4 / 100;
        ...
        console.log('\n=== 修复总结 ===');
        console.log('1. 涨跌百分比：无论是指数还是股票，都需要除以100');
        console.log('2. 这样可以避免涨跌百分比显示异常（如-36.00%）');
        console.log('3. 涨跌点数：优先使用f3字段，如果f3为0则使用f24字段');
        console.log('4. 当前价格：优先使用f2字段，如果f2为0则使用f18字段');
        console.log('5. 除数：指数使用1，股票使用100');
...
testFinalPercentFix().catch(console.error);
